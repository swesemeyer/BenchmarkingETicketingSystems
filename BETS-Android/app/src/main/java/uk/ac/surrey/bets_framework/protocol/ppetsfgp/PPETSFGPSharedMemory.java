...
public class PPETSFGPSharedMemory extends NFCAndroidSharedMemory {
  ...
  public static PPETSFGPSharedMemory fromJson(String json) {
    ...
    // Now create the pairing and use it to get the field needed to deserialize all the elements.
  ...
  public void clear() {
    ...
    // Now complete the setup of the public parameters, which need the bilinear group and private central authority data.
  ...
  /**
   * Clears out the shared memory except for those parameters set for the state machine needed for debugging/unit testing.
   */
   ...
   *
   * @param actor The actor to obtain data for.
