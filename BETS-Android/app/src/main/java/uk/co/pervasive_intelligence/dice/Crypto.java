...
public class Crypto {
  ...
  private Crypto() {
    ...
    // Following the instructions at https://rtyley.github.io/bouncycastle/, we ensure it is used in preference to all other
    // security providers.
  ...
  public byte[] getHash(byte[] data) {
    ...
    try {
      final MessageDigest digest = MessageDigest.getInstance(this.hashParameters, BouncyCastleProvider.PROVIDER_NAME);
      digest.update(data);
      hash = digest.digest();
