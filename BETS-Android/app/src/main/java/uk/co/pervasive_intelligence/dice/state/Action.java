...
public class Action<T> {
  ...
  /** Which NFC command should be run? May be null to indicate no command. */
  private T command = null;

  /** NFC command data. May be null to indicate no command data. */
   ...
   * @param nextState             What should the next state be? Use {@link #NO_STATE_CHANGE} to stay in the same state.
   * @param command               Which NFC command should be run? May be null to indicate no command.
   * @param commandData           NFC command data. May be null to indicate no command data.
  ...
  /**
   * @return Which NFC command should be run? May be null to indicate no command.
   */
  public T getCommand() {
    return this.command;
  }
  ...
  /**
   * @return NFC command data. May be null to indicate no command data.
   */
