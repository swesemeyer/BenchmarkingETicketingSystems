...
/**
 * Implements the PPETS-FGP (Han, submitted) NFC protocol as a state machine.
 *
 * Han, J., Chen, L., Schneider, S. & Treharne, H. (submitted).
 * "PPETS-FGP: Privacy-preserving Electronic Ticket Scheme with Fine-grained Pricing".
 *
 * @author Matthew Casey
 */
public class PPETSFGP extends NFCReaderStateMachine {

  /** Logback logger. */
  private static final Logger  LOG          = LoggerFactory.getLogger(PPETSFGP.class);
   ...
   */
  public PPETSFGP() {
    super(Arrays.asList(new PPETSFGPSetupStates.SState00(), new PPETSFGPSetupStates.SState01(), 
        new PPETSFGPSetupStates.SState02(), new PPETSFGPSetupStates.SState03(), 
        new PPETSFGPRegistrationStates.RState04(), new PPETSFGPRegistrationStates.RState05(),
        new PPETSFGPRegistrationStates.RState06(), new PPETSFGPRegistrationStates.RState07(), 
        new PPETSFGPIssuingStates.IState08(), new PPETSFGPIssuingStates.IState09(), 
        new PPETSFGPIssuingStates.IState10(), new PPETSFGPValidationStates.VState11(),
        new PPETSFGPValidationStates.VState12(), new PPETSFGPValidationStates.VState13()));
  }
